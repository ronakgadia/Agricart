	...
	if(isset($_POST['save']))
	{
		...
		$myemail = mysqli_real_escape_string($connect,$_POST['email']);		
		  ...
		  // Finally, register user if there are no errors in the form
			$query = "UPDATE register SET username='$myuname', mobile_no=$mymobilenumber, email='$myemail' WHERE register_id=
			'$user_id'"; 
...
<form action="editprofile.php" method="post">
    <label for="staticEmail" class="col-sm-2 col-form-label" style="font-size: 20px;font-weight: bold;margin-left:-15px;" >Name:</label>
		<input type="text" class="form-control-plaintext" style="font-size: 20px;" name="uname" value="<?php echo $row['username']; ?>">
		<input type="submit" value="Save" class="btn btn-primary" style="float: right;margin-top: -40px;" name="save">
	<hr>
  
	<label for="staticEmail" class="col-sm-2 col-form-label" style="font-size: 20px;font-weight: bold;margin-left: -15px;" >E-mail:</label>
		<input type="text" class="form-control-plaintext" style="font-size: 20px;" name="email" value="<?php echo $row['email']; ?>">
		<input type="submit" value="Save" class="btn btn-primary" style="float: right;margin-top: -40px;" name="save">
	<hr>
   
	<label for="staticEmail" class="col-sm-2 col-form-label" style="font-size: 20px;font-weight: bold;margin-left: -15px;" >Mobile:</label>
		<input type="text" class="form-control-plaintext" style="font-size: 20px;" name="mobilenumber" value="<?php echo $row['mobile_no']; ?>">
		<input type="submit" value="Save" class="btn btn-primary" style="float: right;margin-top: -40px;" name="save">
	<hr>
	...
	<label for="staticEmail" class="col-sm-2 col-form-label" style="font-size: 20px;font-weight: bold;margin-left: -15px;">Password:</label>
		<input type="password" class="form-control-plaintext" style="font-size: 20px;" name="psw_1" value="">
		<input type="submit" value="Save" class="btn btn-primary" style="float: right;margin-top: -40px;" name="save">
	<hr>
   
	<label for="staticEmail" class="col-sm-2 col-form-label" style="font-size:20px;font-weight: bold;margin-left: -15px;max-width:250px">Confirm Password:</label>
		<input type="password" class="form-control-plaintext" style="font-size: 20px;" name="psw_2" value="">
		<input type="submit" value="Save" class="btn btn-primary" style="float: right;margin-top: -40px;" name="save">
	<hr>
	
	<label for="staticEmail" class="col-sm-2 col-form-label" style="font-size: 20px;font-weight: bold;margin-left: -15px;">Address:</label>

		<input type="text" class="form-control-plaintext" style="font-size: 20px;" name="street" value="<?php if(!empty($result)){ echo $address['street_address'];} else { echo "Street";} ?>">
		<input type="text" class="form-control-plaintext" style="font-size: 20px;" name="city" value="<?php if(!empty($result)){ echo $address['city'];} else { echo "City";} ?>">
		<input type="text" class="form-control-plaintext" style="font-size: 20px;" name="state" value="<?php if(!empty($result)){ echo $address['state'];} else { echo "State";} ?>">
		<input type="text" class="form-control-plaintext" style="font-size: 20px;" name="pincode" value="<?php if(!empty($result)){ echo $address['pincode'];} else { echo "Pincode"; }?>">

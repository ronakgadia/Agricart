...
<div class="mainbox">
	...
	<span class = "error"><?php /*echo*/ $nameErr;?></span><br>-->
		...
		<input type="text" placeholder="Enter the shop name" name="uname">
		<span class = "error"><?php echo $nameErr;?></span><br>
    	</div>
	  ...
	  <div class="form-row">
		...
		<input type="text" placeholder="Enter the license number" name="uname">
		<span class = "error"><?php echo $nameErr;?></span><br>
    	</div>
    	<div class="form-group col-md-6">
		<label for="uname">Landmark</label>
		<input type="text" placeholder="Enter the landmark" name="uname">
		<span class = "error"><?php echo $nameErr;?></span><br>
    	</div>
  	  </div>
	  ...
	  <div class="form-row">
		...
		<input type="text" placeholder="Enter the district" name="uname">
		<span class = "error"><?php echo $nameErr;?></span><br>
    	</div>
    	<div class="form-group col-md-6">
		<label for="uname">State</label>
		<input type="text" placeholder="Enter the state" name="uname">
		<span class = "error"><?php echo $nameErr;?></span><br>
    	</div>
  	  </div>
	  ...
	  <div class="form-row">
		...
		<input type="text" placeholder="Enter the mobile number" name="uname">
		<span class = "error"><?php echo $nameErr;?></span><br>
    	</div>
     	<div class="form-group col-md-6">

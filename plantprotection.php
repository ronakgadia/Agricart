...
<html>
	...
	<!--<div>
		<ul class="menu-bar">
			...
			<li class="lfloat"><a href="plantprotection.php" class="active menu-bar-list">PLANT PROTECTION</a></li>
			<li class="lfloat"><a href="plantnutrition.php" class="menu-bar-list">PLANT NUTRITION</a></li>
			...
			<div class="card" style="margin-top:10px;margin-left:-20px;width:100%;">
				...
				<div class="check-list">
						<h3 style="color:#5B6775" >Category</h3>
							...
							$query = "SELECT DISTINCT(category) FROM product WHERE type='Plant Protection'";
...
<!--				</div>
				...
				<br>
					<h3 style="color:#5B6775" >Brand</h3>
						<div style="max-height:300px; overflow-y: auto; overflow-x: hidden;">
						<?php
						$query = "SELECT DISTINCT(brand) FROM product WHERE type='Plant Protection'";
						$result = mysqli_query($connect,$query);
				...
				<div class="check-list">
					...
					<h3 style="color:#5B6775" >State</h3>
						<div style="max-height:300px; overflow-y: auto; overflow-x: hidden;">
						<?php
						$query = "SELECT DISTINCT(state) FROM product INNER JOIN shop ON product.shop_id=shop.shop_id WHERE type='Plant Protection'";
						$result = mysqli_query($connect,$query);
...
<!--						<button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">State
				...
				<div class="check-list">
					...
					<h3 style="color:#5B6775" >District</h3>
						...
						<?php
						$query = "SELECT DISTINCT(district) FROM product INNER JOIN shop ON product.shop_id=shop.shop_id WHERE type='Plant Protection'";
						$result = mysqli_query($connect,$query);
